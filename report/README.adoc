...
Lorsque l'on retire l'appel à la méthode shuffle, on retire simplement le coté aléatoire de la construction des différents rounds. Les joueurs seront mis dans des parties en fonction de leur ordre d'arrivé. Il s'agit d'un mutant équivalent.
